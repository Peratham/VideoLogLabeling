            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="<?=\app\Url::to([(\app\Application::$app->user->isGuest?'login':'logout')])?>"><?=(\app\Application::$app->user->isGuest?'Login':'Logout')?></a></li>
                        <li><a href="<?=\app\Url::to(['upload'])?>">Upload</a></li>
                        <li class="dropdown">
